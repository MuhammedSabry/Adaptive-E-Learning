...
public class HotCoursesInteractor extends FlowableUseCase<List<FancyCourse>, String> {

    private CourseService courseService;

    @Inject
    HotCoursesInteractor(BackgroundExecutionThread backgroundExecutionThread,
    ...
    protected Flowable<List<FancyCourse>> interact(String token) {
        return courseService.getHotCourses().toFlowable(BackpressureStrategy.BUFFER);
    }
}
